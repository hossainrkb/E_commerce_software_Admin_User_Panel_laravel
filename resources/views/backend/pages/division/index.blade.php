      ...
      <div class="card-body">
        ...
        <table class="table table-hover table-striped ">
          ...
          <tr>
            ...
            <td> <a href="{{ route ('admin.division.edit', $division->id) }}" class="btn btn-outline-primary btn-sm"> Edit</a>
              <a href="#deleteModal{{ $division->id }}" data-toggle="modal"  class="btn btn-outline-danger btn-sm"> Delete</a>

              <!-- DeleteModal -->
              <div class="modal fade" id="deleteModal{{ $division->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="{{route('admin.division.delete', $division->id)}}" method="post">
                        {{ csrf_field() }}
                        <button type="submit" class="btn btn-outline-danger" >ok,Permanently Delete This Division?</button>
