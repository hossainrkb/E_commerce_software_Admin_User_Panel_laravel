                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="text" class="form-control @error('name') is-invalid @enderror" name="phone_no" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_address" type="text" class="form-control @error('name') is-invalid @enderror" name="street_address" value="{{ old('name') }}" required autocomplete="name" autofocus>
